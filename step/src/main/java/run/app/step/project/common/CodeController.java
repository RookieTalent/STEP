...
public class CodeController {
    ...
    public AjaxResult obtionCaptcha(HttpServletRequest request){
        ...
        String mobile = userService.selectUserById(JwtTokenUtil.obtainUserId(access_token)).getMobile();

        boolean result = smsService.send(access_token, code, mobile);
