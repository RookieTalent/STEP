...
import run.app.step.common.exception.RedisException;
...
public class RedisService {
    ...
    public Long getExpire(String key, TimeUnit unit) {
        if(null==key||null==unit){
            throw new RedisException("key or unit must not be null");
        }
    ...
    public Boolean setifAbsen(String key,Object value,long time,TimeUnit unit){
        ...
        if(null==key||null==value||null==unit){
            throw new RedisException("key value or unit must not be null");
        }
...
//******************hash数据类型*********************
    ...
    public Long hIncrBy(String key,Object field,long increment){
        if (null==key||null==field){
            throw new RedisException("key or field 不能为空");
        }
    ...
    public Double zincrby(String key, double score, Object member) {
        if (null==key){
            throw new RedisException("key 不能为空");
        }
